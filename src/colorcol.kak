...
declare-option -hidden str colorcol_mode "range"
...
colorcol "$kak_buffile" "$kak_opt_colorcol_mode" "$kak_opt_colorcol_max_flags" "$kak_opt_colorcol_flag_str" "$kak_opt_colorcol_replace_str"
}}
